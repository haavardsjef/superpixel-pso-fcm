...
public class WeightedSumExperiement implements IExperiment {
	...
	public void runExperiment() throws IOException {
		...
		String filterString = "attributes.status = 'FINISHED' and params.dataset = 'indian_pines' and params.repair = 'v4' and params.distanceMeasure = 'SP_LEVEL_KL_DIVERGENCE_L1NORM'";
		...
		for (Service.Run run : runs) {
			...
			double w_e = 1.0;
			Double[] w_ctValues = new Double[]{2.5, 2.75, 3.0, 3.25};
			cr.setW_e(w_e);
